...
public class Way2SMS {
    ...
    {  
        final String USERNAME="9940345820";//REQUIRED
        final String PASSWORD="leaf123";//REQUIRED
        ...
        if(args.length>0)
        {
          ...
          {
            System.out.println("USAGE : Way2SMS phone <7845186305>  ... message <hi this is gopi>");
            System.exit(0);
          }
        } 
        else
