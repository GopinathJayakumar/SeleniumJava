...
public class LearnString {
	...
	public static void stringAddress(){
		...
		String a = "GopinathJayakumar";
		String b = "GopinathJayakumar1";
		System.out.println("Memory address of a: "+ System.identityHashCode(a));
		System.out.println("Memory address of b: "+ System.identityHashCode(b));
		System.out.println(a==b);
		System.out.println(a.equals(b));

		String a1 = new String("GopinathJayakumar");
		String b1 = new String("GopinathJayakumar");
	...
	public static void stringBufferAddress(){
		...
		String a = "GopinathJayakumar"; // literal
		String comp = new String("GopinathJayakumar"); // object of class
		String a1 = "GopinathJayakumar";
		...
		//	StringBuffer b = new StringBuffer("GopinathJayakumar");
		//	System.out.println("Memory address of b: "+ System.identityHashCode(b));

		//	b.append(" GopinathJayakumar");
		//	System.out.println("Memory address of b: "+ System.identityHashCode(b));
	...
	public static void checkLiteral(){
		String a = "GopinathJayakumar"; 
		String b = "GopinathJayakumar";
		System.out.println(a == b);  // true
		String c = new String("GopinathJayakumar");
		String d = new String("GopinathJayakumar");
